...
type FormValues = {
  ...
  job_title: string;
  company_name: string;
  help: "Evaluate value for my company" | "Learn More" | "Get a Quote" | "Other";
  services:
    |"Web App Develoment"
    | "Mobile App Develoment"
    | "Social Media Marketing"
...
export default function ContactForm() {
  ...
  return (
    <div className=" w-full   md:items-center md:justify-center bg-blue-800 antialiased bg-grid-white/[0.02] relative overflow-hidden ">
      <Navbar
            ...
            >
                ...
                render={({ field }) => (
                  <FormItem className="items-center justify-center  w-full">
                    ...
                    >
                      ...
                      <SelectContent>
                        <div className="flex gap-4">
                          <SelectItem value="Evaluate Value for my company">
                            Evaluate Value for my company
                          </SelectItem>
                        </div>
              ...
              <div className="flex gap-4 items-center">
                ...
                <div className="text-xs font-light  md:w-3/4 mb-1 bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400">
                  I agree to perwriters&apos; sending marketing communications related
                  to marketing
                </div>
              </div>
