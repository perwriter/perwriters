...
const Navbar = ({
  ...
  return (
    <div>
      <div className="p-6 md:p-10 flex items-center justify-between z-50 shadow-sm shadow-blue-500/30 ">
        <div>
        ...
        <div className="hidden md:flex">
          <Link
            ...
            rounded-md border border-slate-800 bg-[linear-gradient(110deg,#184681,45%,#1165da,55%,#040f25)] 
